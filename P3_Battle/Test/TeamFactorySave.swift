...
//import Foundation
//
//class TeamFactorySave: Team {
//
//  //MARK: - Vars
//  var checkNameTeam = [String]()
//  var arrayTeams = [Team]() // ??? ou [TeamFactory]()
...
//      createCharacter()
//      // test print
//      print("Test print in createCharacterSSS()")
//      print("display check name : \(checkNameTeam)")
//      print("display characters : \(characters)")
//    }
...
//      createTeam()
//      // test print
//      print("Test print in createTeamSSS()")
//      print("display check name : \(checkNameTeam)")
//      print("display characters : \(characters)")
//      for character in checkNameTeam {
//        print("\(character)")
